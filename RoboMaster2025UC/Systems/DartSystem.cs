...
public sealed partial class DartSystem(
    ...
    ILogger logger,
    IMatchConfigurationRM2025uc matchConfiguration,
    ...
    : ISystem
{
    ...
    public Task Reset(CancellationToken cancellation = new())
    {
        ...
        SetDartRemaining(Camp.Blue, RM2025ucPerformanceSystem.MaxDartCount);
        SetDartRemaining(Camp.Red, RM2025ucPerformanceSystem.MaxDartCount);
    ...
    public bool TryLaunchDart(Camp camp)
    {
        ...
        if (
            ...
            < RM2025ucPerformanceSystem.DartFireInterval
        )
            return false;

        var target = GetCurrentTarget(camp);
        var dartIndex = RM2025ucPerformanceSystem.MaxDartCount - GetDartRemaining(camp);
        ...
        timeSystem.RegisterOnceAction(
            JudgeSystemStage.Match,
            now + RM2025ucPerformanceSystem.DartFlyDuration,
            () =>
            {
