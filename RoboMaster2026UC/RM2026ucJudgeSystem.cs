...
public sealed class RM2026ucJudgeSystem : JudgeSystem
{
    ...
    public static void Build(IContainerBuilder builder)
    {
        ...
        builder
            .Register<PerformanceSystemBase, RM2026ucPerformanceSystem>(Lifetime.Scoped)
            .AsSelf();
        builder.Register<ISystem, EconomySystem>(Lifetime.Scoped).AsSelf();
        builder.Register<ISystem, LifeSystem, RM2026ucLifeSystem>(Lifetime.Scoped).AsSelf();
        ...
        builder
            .Register<ISystem, OperatorSystem, RM2026ucOperatorSystem>(Lifetime.Scoped)
            .AsSelf();
        ...
        builder
            ...
            .AsSelf();
        builder.Register<JudgeSystem, RM2026ucJudgeSystem>(Lifetime.Scoped).AsSelf();
