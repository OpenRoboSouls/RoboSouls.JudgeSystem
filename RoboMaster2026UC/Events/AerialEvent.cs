...
/// <param name="AerialId"></param>
/// <param name="Time"></param>
public readonly record struct AerialLockStoppedEvent(Identity AerialId, double Time) : IJudgeSystemEvent<AerialLockStoppedEvent>;
...
/// <param name="AerialId"></param>
/// <param name="Time"></param>
public readonly record struct AerialCounteredEvent(Identity AerialId, double Time) : IJudgeSystemEvent<AerialCounteredEvent>;