...
public sealed class BattleSystem : IBattleSystem
{
    ...
    [Inject] internal RM2025ulPerformanceSystem PerformanceSystem { get; set; }
    ...
    private Task CooldownTaskFor(IShooter shooter)
    {
        ...
        if (q1 > q2) BuffSystem.AddBuff(shooter.Id, RM2025ulBuffs.HeatGunLocked, 2, TimeSpan.MaxValue);
