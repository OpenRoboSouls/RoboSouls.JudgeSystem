...
using RoboSouls.JudgeSystem.RoboMaster2025UL.Systems;
using RoboSouls.JudgeSystem.Systems;
using VContainer;

namespace RoboSouls.JudgeSystem.RoboMaster2025UL;
...
public sealed class RM2025ulJudgeSystem : JudgeSystem
{
    ...
    public static void Build(IContainerBuilder builder)
    {
        ...
        builder
            .Register<PerformanceSystemBase, RM2025ulPerformanceSystem>(Lifetime.Scoped)
            .AsSelf();
        builder.Register<ISystem, EconomySystem>(Lifetime.Scoped).AsSelf();
        builder.Register<ISystem, LifeSystem, RM2025ulLifeSystem>(Lifetime.Scoped).AsSelf();
        ...
        builder.Register<JudgeSystem, RM2025ulJudgeSystem>(Lifetime.Scoped).AsSelf();
        builder
